...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body id="body-layout" style="background: #df2e2e;">
      ...
      <tr>
        <td align="center" valign="top" style="padding: 0 15px;background: #ffffff;">
          <table align="center" cellpadding="0" cellspacing="0" border="0">
            ...
            <tr>
              <td width="600" align="center" valign="top" style="border-radius: 4px; overflow: hidden; box-shadow: 3px 3px 6px 0 rgb(239, 34, 34);background: #dde1e6;">
                <table width="100%" align="center" cellpadding="0" cellspacing="0" border="0">
                  <tr>
                    <td align="center" valign="top" style="border-top-left-radius: 4px; border-top-right-radius: 4px; overflow: hidden; padding: 0 20px;background: rgb(239, 34, 34);">
                      <table width="100%" align="center" cellpadding="0" cellspacing="0" border="0">
                        <tr>
